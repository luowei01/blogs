...
LastEditTime : 2024-05-28 13:04:47
        ...
        for file in files:
            ...
            if file.endswith(('.png', '.jpg', '.jpeg', '.gif', '.bmp')):
                ...
                if file_path not in watermarked_files:
                    # 如果图片没有添加水印，则添加水印
                    add_mark(file_path, watermark_text,out=root,space=100)
                    # 记录已添加水印的文件名
...
add_watermark_to_images(r"比赛相关", "WHUT @luowei",watermarked_record_file)
