...
<html lang="{{ config.language }}" {% if page.dir == "rtl" %}dir="rtl"{% endif %}>
    ...
    <body>
        ...
        <div class="navbar">
            <a href="https://chateda.top/">首页</a>
            <a href="https://chateda.top/about/">关于</a>
            <a href="https://chateda.top/archive/">归档</a>
            <a href="https://chateda.top/tags/">标签</a>
            <a href="{{ site.baseurl }}/" class="current">全部博客</a>
        </div>
